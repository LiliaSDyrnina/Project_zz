...
label1 = tk.Label(root, text="Здравствуй!",font="TkHeadingFont 17",bg="white")
label1.place(x=100, y=100)
label2 = tk.Label(root, text="Введи дату рождения",font="Courier 15",bg="white")
...
def button1_click():
    data=str(entry.get())
    label3 = tk.Label(root, text="Вы",font="Courier 19",bg="white")
    label3.place(x=150, y=220)
    buttonw = tk.Button(root, text="женщина",font="Courier 13",bg="blue",command=buttonw_click)
    buttonw.place(x=206, y=220)
    buttonm = tk.Button(root, text="мужчина",font="Courier 13",bg="red",command=buttonm_click)
    buttonm.place(x=295, y=220)
    return data
    
button1 = tk.Button(root, text="ok",font="Courier 10",bg="white", command=button1_click)
